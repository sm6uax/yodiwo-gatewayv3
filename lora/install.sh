...
INSTALL_DIR="/opt/yodiwo-gatewayv3"
...
echo "Open Yodiwo console and register your gateway using your EUI: https://cyan.yodiwo/gateways"
echo
...
sed -i "s/^.*server_address.*$/\t\"server_address\": \"127.0.0.1\",/" /opt/yodiwo-gatewayv3/packet_forwarder/lora_pkt_fwd/global_conf.json
